          ...
          <div>
            ...
            <div className="mt-16">
              ...
              <div className="w-72">
                ...
                <button className="w-full py-2 px-6 bg-primary hover:bg-primary-600 text-white rounded-full font-bold" onClick={() => setShowSignupModal(true)}>Sign up with phone or email</button>
                <div className="text-xs text-gray-400 mt-2">
                  ...
                  , including{" "}
                  <a className="text-primary hover:underline" href="Cookie Use">
                    Cookie Use
                  </a>
                  .
                </div>
